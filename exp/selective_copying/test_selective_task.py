...
Run: uv run pytest exp/selective_copying/test_selective_task.py -v
"""

import pytest
import torch

from exp.selective_copying.task import (
    BLANK, MARKER, MARKER_LEN, MEMORY_LEN, VOCAB_SIZE,
    make_batch, mask_non_answer, seq_len_for,
)

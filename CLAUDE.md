...
- STARTED2026-09-14 14:39:11 JST, supervisor3120752, workers3120755/3120756 (Copying/Selective). First100 steps bit-match benchmarks and initial weights match. Preparation `e7c4004`; expected finish around19:40 JST, hard deadline22:02:35 JST. Supervisor performs50k each, best/final880 cells and CPU audit, then stops. `doc/experiments/logkv-variable-memory-20260914/launch.json` records launch evidence.

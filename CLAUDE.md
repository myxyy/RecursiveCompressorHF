...
- See `doc/logkv-causal-conv.md` and `doc/experiments/logkv-causal-conv-20260914/`. Results pending during preparation; update launch/status after evaluation smoke. All large artifacts live under `/mnt/raid0/RecursiveCompressor/experiments/logkv-causal-conv-20260914/`.

...
- Started 2026-09-14 11:04:31 JST on GPUs0/1, supervisor PID 2877069, workers 2877070/2877071. Both first 100-step intervals bit-match their benchmarks. Preparation commit `dab79f2`; source `4bfee1f`; main still `d707675`. Expected finish around 15:20 JST; hard stop 18:30:42 JST. No extra stages queued.
- See `doc/logkv-causal-conv.md` and `doc/experiments/logkv-causal-conv-20260914/`. Results pending while running. All large artifacts live under `/mnt/raid0/RecursiveCompressor/experiments/logkv-causal-conv-20260914/`. Do not edit running scripts/frozen source/prerequisite JSON; the supervisor verifies their hashes at completion.

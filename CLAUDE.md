...
- STARTED2026-09-15 16:43:00 JST on GPUs0/1; supervisor306138, workers306150/306151. First100 metrics AND beta histories bit-match benchmarks; baseline config differs only run_name/learnable_decay/num_params. Branch `adjust-attenuation`, preparation `1762bfb`, frozen source `0e2e949`; main standard unchanged. Expected finish around21:00 JST; hard stop2026-09-16 00:07:56 JST. `launch.json` records evidence.

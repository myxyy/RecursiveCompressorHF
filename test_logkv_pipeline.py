...
CUDA_VISIBLE_DEVICES=0,1 torchrun --standalone --nproc_per_node=2 \
    test_logkv_pipeline.py --distributed-smoke /path/to/empty/smoke-dir
"""
...
from logkv_lm_pipeline import LogKVLMPipelineStage, export_model
from train_logkv import build_parser
from train_logkv_pipeline import (EpochCursorSampler, PipelineEngine, checkpoints,
...
def test_export_load_streaming_and_sharded_warm_start(tmp_path):
    ...
    # These are the exact functions imported by predict_stream.py.
    from predict_stream import _load_model, _load_tokenizer, stream_generate

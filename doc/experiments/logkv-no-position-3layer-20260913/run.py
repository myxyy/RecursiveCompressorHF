...
def main():
    ...
    record=dict(tasks=list(MODES),state='starting',started=now(),pid=os.getpid(),gpu_limit=2,gpus=list(GPUS),combined_authorized_gpu_limit=4,num_layers=NUM_LAYERS,

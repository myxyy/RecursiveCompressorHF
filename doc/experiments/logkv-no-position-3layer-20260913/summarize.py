...
def main():
    ...
    def audit(mode,cp,kind,metrics,records,ts,n):
        ...
        for T in ts:
            ...
            rows.append(dict(mode=mode,task=mode,position_mode="none",num_layers=NUM_LAYERS,checkpoint=cp,evaluation=kind,T=T,n=n,
    ...
    table=['# Three-layer main architecture without phase embeddings: automatically audited results','',
    ...
    from compare_depth import main as compare_depth
    compare_depth()

...
def checked_init(self, config):
    ...
    # Match all shared initial parameters to the ongoing two-layer control;
    # only the extra layer comes from fresh three-layer initialization.
    ...
    save(out / 'initialization_audit.json', dict(passed=True, **task_identity(),
        ...
        num_layers=NUM_LAYERS, num_params=NUM_PARAMS,

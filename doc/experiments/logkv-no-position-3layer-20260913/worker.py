...
import subprocess
import sys
from common import HERE, ROOT, SOURCE, MODES, NUM_LAYERS, NUM_PARAMS, run_dir, command, now, save, sha
...
def main():
    ...
    try:
        ...
        assert cfg['steps'] == 50000 and cfg['num_params'] == NUM_PARAMS and cfg['num_layers'] == NUM_LAYERS

...
def main():
    ...
    for mode in MODES:
        ...
        assert init['passed'] and init['deterministic_algorithms']
    ...
    table=['# End-anchored RoPE comparison: automatically audited results','',
    ...
    save(dest/'review.json',dict(passed=True,standard_cells=2*2*41,paired_cells=2*2*len(PAIRED_TS),

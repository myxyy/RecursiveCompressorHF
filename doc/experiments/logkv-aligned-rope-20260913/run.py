...
def main():
    ...
    record=dict(state='starting',started=now(),pid=os.getpid(),gpu_limit=2,gpus=[0,1],
        estimated_hours=preflight['estimated_campaign_hours'],time_limit_hours=7.5,source_manifest=manifest,

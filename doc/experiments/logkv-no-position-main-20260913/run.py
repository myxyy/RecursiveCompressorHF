...
import sys
import time
from common import HERE, ROOT, SOURCE, INITIAL, MODES, now, save, sha, run_dir
...
def main():
    ...
    record=dict(tasks=list(MODES),state='starting',started=now(),pid=os.getpid(),gpu_limit=2,gpus=[0,1],

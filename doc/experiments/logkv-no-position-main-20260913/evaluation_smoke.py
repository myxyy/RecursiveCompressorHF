...
import sys
import torch
from common import HERE, ROOT, SOURCE, MODES, name, save
...
def main():
    ...
    for gpu, mode in enumerate(MODES):
        ...
        for cp in ['best', 'final']:
            ...
            env = {**os.environ, 'CUDA_VISIBLE_DEVICES': '0', 'LOGKV_TASK': mode,
    ...
    save(HERE / 'evaluation_smoke.json', dict(passed=True, tasks=list(MODES),
        ...
        checkpoint_training_steps=300, targets_and_positions_replayed=True))

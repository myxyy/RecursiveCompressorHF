...
def main():
    ...
    def audit(mode,cp,kind,metrics,records,ts,n):
        ...
        for T in ts:
            ...
            rows.append(dict(mode=mode,task=mode,position_mode="none",checkpoint=cp,evaluation=kind,T=T,n=n,
    ...
    table=['# Main architecture without phase embeddings: automatically audited results','',

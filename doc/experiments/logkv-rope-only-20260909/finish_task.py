...
report=HERE.parents[1]/'logkv-rope-only.md'
text=report.read_text()
if args.task=='copying':
 text=text.replace('Copyingは学習・評価中で、性能結果はまだ未確定。',
 ...
 text+='\nSelective Copying段階も完了し、保存結果のCPU検証が成功した。\n[Selectiveの全結果・図表](experiments/logkv-rope-only-20260909/selective-copying/README.md)を保存した。\n'

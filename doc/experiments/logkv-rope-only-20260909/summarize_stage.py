...
def main():
 ...
 for mode in MODES:
  ...
  folder=ROOT/'exp'/args.task/f'{mode}-no-phase-fixed10-20260909';out=dest/mode;out.mkdir(exist_ok=True)
  ...
  assert not cfg['phase_emb'] and cfg['phase_levels']==2 and cfg['steps']==50000

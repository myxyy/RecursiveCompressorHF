...
Usage:
    uv run python -m inference.chat_server
    uv run python -m inference.chat_server --model-dir /path/to/local/checkpoint
    uv run python -m inference.chat_server --port 8080 --host 0.0.0.0
"""

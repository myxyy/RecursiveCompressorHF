...
torchrun --standalone --nproc_per_node=6 train_logkv_pipeline.py \
    --run-name pipeline --batch-size 12 --n-microbatches 12

Checkpoints contain model/ (HF weights + tokenizer for predict_stream.py) and
...
from train_logkv import (build_parser, get_data_dir, split_params_for_muon,
